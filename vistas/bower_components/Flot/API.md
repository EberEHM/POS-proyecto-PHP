...
<div class='flot-x-axis flot-x1-axis'>
    <div class='flot-tick-label'>Enero 2013</div>
    ...
</div>
```
...
restriction on another axis Mayo  make some of them invisible (this
...
don't use any interactive features of Flot, you Mayo  not need it.
...
of this axis are aligned with the ticks of the other axis. This Mayo 
...
Javascript timestamp is the number of milliseconds since Enero 1,
...
zone, so it Mayo  take a little bit of tweaking to work around this
limitation.
...
```js
monthNames: ["Ene", "feb", "mar", "Abr", "maj", "jun", "jul", "Ago", "sep", "okt", "nov", "Dec"]
```
...
which will format Deciembre 24 as 24/12:
...
can call:
 ...
 - highlight(series, datapoint)
    ...
    "plotclick" event, or you can specify the inDeces, e.g.
...
hooks in the plugins bundled with Flot.
 ...
 - processRawData  [phase 3]
    ...
    This inDecates that a point, i.e. [0, 25], consists of two values, with the

...
// =============================================*/
// esta funcion lo que hacia era asignar un codigo automatico dependiendo de la categoria
// a la que pertenece
...
$("#editarPrecioCompra").change(function(){
	...
	if($(".cajaPorcentaje").prop("checked")){
...
$(".cajaPorcentaje").on("ifUnchecked",function(){

	$("#editarPrecioVenta").prop("readonly",false);

})

$(".cajaPorcentaje").on("ifChecked",function(){
...
$(".tablAbroductos tbody").on("click", "button.btnEliminarProducto", function(){
	...
	swal({
        ...
        if (result.value) {
        	...
        	window.location = "index.php?ruta=productos&idPro="+idPro+"&imagen="+imagen+"&codigo="+codigo;
...
=============================================*/
$(document).on("click", ".btnActivarOptimizacion", function(){

  var idProductos = $(this).attr("idProductos");
  var estadoProductos = $(this).attr("estadoProductos");

  var datos = new FormData();
  datos.append("activarIdOptimizacion", idProductos);
    datos.append("activarOptimizacion", estadoProductos);
    $.ajax({
    ...
    if(estadoProductos == 0){

      swal({

    title: 'AVISO',
    text: "Si cuenta con mas de 500 productos, use la tabla en modo optimizada",
    type: 'warning',
        confirmButtonColor: '#3085d6',

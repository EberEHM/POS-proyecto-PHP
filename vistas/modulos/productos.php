    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-tools pull-right">
          <!-- Boton activar optimizacion de productos -->
          ...
          $estado= ControladorProductos::ctrMostrarEstado($item, $valor);
            ...
            if($estado["estado"] != 0){
                    ...
                    echo '<td><button class="btn btn-success btn-xs btnActivarOptimizacion" idProductos="'.$estado["id"].'" estadoProductos="0"> Tabla optimizada</button></td>';

                  }else{

                    echo '<td><button class="btn btn-danger btn-xs btnActivarOptimizacion" idProductos="'.$estado["id"].'" estadoProductos="1"> Optimizar tabla</button></td>';
